...
void render::CircularProgressBar(int x, int y, int radius, int start_angle, int percent, int thickness, Color color)
{
...
void render::draw_arc2(int x, int y, int radius, int startangle, int percent, int thickness, Color color)
{
